...
public class TournamentCategoryService {
    ...
    private TournamentCategoryDetailResponse toResponse(TournamentCategory tournamentCategory, Account account) {
        ...
        return TournamentCategoryDetailResponse.builder()
                ...
                .clubRegistrationFee(tournamentCategory.getClubRegistrationFee())
                .minClubRosterSize(tournamentCategory.getMinClubRosterSize())
                .maxClubRosterSize(tournamentCategory.getMaxClubRosterSize())
                .teamMatchFormat(tournamentCategory.getTeamMatchFormat())
